    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 bg-[#070b13] overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="backdrop-blur-3xl bg-slate-950/40 border border-slate-800/60 shadow-[0_24px_80px_rgba(0,0,0,0.6)] rounded-[32px] p-6 sm:p-10">
          ...
          {/* Card-level Error Notification */}
          {errorMsg && (
            <div className="flex items-start gap-3 bg-red-500/10 border border-red-500/25 text-red-200 text-sm rounded-2xl p-4 animate-fadeIn mb-6">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3.5 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white shadow-[0_4px_20px_rgba(99,102,241,0.3)]"
            >
              {loading ? (
                <>
